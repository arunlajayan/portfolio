    ...
    <div className="bg-blue-500 overflow-hidden relative" style={{ width: '800px', height: '200px' }}>
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        <div>
          ...
          <a
            href="https://www.linkedin.com/posts/jithinrobert_kudos-teamplayer-activity-6996322095706120192-_DKJ"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-200 hover:text-blue-300 text-sm"
          >
            <img src="assets/svg/linkedin.svg" width={20} alt="LinkedIn" />
          </a>
          <p className="text-white text-sm">CEO, iLapz Technologies</p>
          #Kudos It&rsquo;s honestly hard to explain how integral you are to this team #TeamPlayer
        </div>
      </div>
    </div>
  );
